...
var mongoDB = 'mongodb+srv://admin:admin@cluster0-bmopw.mongodb.net/local_library?retryWrites=true'//userArgs[0];
mongoose.connect(mongoDB, {replicaSet: 'Cluster0-shard-0', useNewUrlParser:true});
